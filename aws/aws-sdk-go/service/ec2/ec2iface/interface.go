...
type EC2API interface {
	...
	AllocateIpv6NatAddress(*ec2.AllocateIpv6NatAddressInput) (*ec2.AllocateIpv6NatAddressOutput, error)
	AllocateIpv6NatAddressWithContext(aws.Context, *ec2.AllocateIpv6NatAddressInput, ...request.Option) (*ec2.AllocateIpv6NatAddressOutput, error)
	AllocateIpv6NatAddressRequest(*ec2.AllocateIpv6NatAddressInput) (*request.Request, *ec2.AllocateIpv6NatAddressOutput)
	...
	AssociateIpv6NatAddress(*ec2.AssociateIpv6NatAddressInput) (*ec2.AssociateIpv6NatAddressOutput, error)
	AssociateIpv6NatAddressWithContext(aws.Context, *ec2.AssociateIpv6NatAddressInput, ...request.Option) (*ec2.AssociateIpv6NatAddressOutput, error)
	AssociateIpv6NatAddressRequest(*ec2.AssociateIpv6NatAddressInput) (*request.Request, *ec2.AssociateIpv6NatAddressOutput)
	...
	DescribeIpv6Addresses(*ec2.DescribeIpv6AddressesInput) (*ec2.DescribeIpv6AddressesOutput, error)
	DescribeIpv6AddressesWithContext(aws.Context, *ec2.DescribeIpv6AddressesInput, ...request.Option) (*ec2.DescribeIpv6AddressesOutput, error)
	DescribeIpv6AddressesRequest(*ec2.DescribeIpv6AddressesInput) (*request.Request, *ec2.DescribeIpv6AddressesOutput)
	...
	DisassociateIpv6NatAddress(*ec2.DisassociateIpv6NatAddressInput) (*ec2.DisassociateIpv6NatAddressOutput, error)
	DisassociateIpv6NatAddressWithContext(aws.Context, *ec2.DisassociateIpv6NatAddressInput, ...request.Option) (*ec2.DisassociateIpv6NatAddressOutput, error)
	DisassociateIpv6NatAddressRequest(*ec2.DisassociateIpv6NatAddressInput) (*request.Request, *ec2.DisassociateIpv6NatAddressOutput)
	...
	ReleaseIpv6NatAddress(*ec2.ReleaseIpv6NatAddressInput) (*ec2.ReleaseIpv6NatAddressOutput, error)
	ReleaseIpv6NatAddressWithContext(aws.Context, *ec2.ReleaseIpv6NatAddressInput, ...request.Option) (*ec2.ReleaseIpv6NatAddressOutput, error)
	ReleaseIpv6NatAddressRequest(*ec2.ReleaseIpv6NatAddressInput) (*request.Request, *ec2.ReleaseIpv6NatAddressOutput)
