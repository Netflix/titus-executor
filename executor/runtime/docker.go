...
func (r *DockerRuntime) createTitusContainerConfigFile(c *Container) error {
	...
	f, err := os.OpenFile(containerConfigFile, os.O_RDWR|os.O_CREATE|os.O_EXCL, 0666) // nolint: gas
	if err != nil {
		return err
	}
	defer shouldClose(f)
...
func (r *DockerRuntime) createTitusEnvironmentFile(c *Container) error {
	...
	f, err := os.OpenFile(envFile, os.O_RDWR|os.O_CREATE|os.O_EXCL, 0666) // nolint: gas
	if err != nil {
		return err
	}
	defer shouldClose(f)
