...
func defaultJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "default.json", size: 17888, mode: os.FileMode(0664), modTime: time.Unix(1648148235, 0)}
...
func fuseContainerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "fuse-container.json", size: 18199, mode: os.FileMode(0664), modTime: time.Unix(1648148235, 0)}
...
func allowPerfSyscallsJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "allow-perf-syscalls.json", size: 18022, mode: os.FileMode(0664), modTime: time.Unix(1648148235, 0)}
