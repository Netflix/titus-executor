...
func defaultJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "default.json", size: 11575, mode: os.FileMode(493), modTime: time.Unix(1535488757, 0)}
...
func fuseContainerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "fuse-container.json", size: 13415, mode: os.FileMode(420), modTime: time.Unix(1535488757, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
