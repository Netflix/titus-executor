...
func defaultJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "default.json", size: 18165, mode: os.FileMode(0664), modTime: time.Unix(1646096945, 0)}
...
func fuseContainerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "fuse-container.json", size: 18476, mode: os.FileMode(0664), modTime: time.Unix(1646096945, 0)}
...
func allowPerfSyscallsJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "allow-perf-syscalls.json", size: 18364, mode: os.FileMode(0664), modTime: time.Unix(1646096945, 0)}
