...
func (AssignIPResponseV3_Route_Family) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_95d23e4d548ba1d7, []int{17, 0, 0}
}
...
func (m *ProvisionInstanceRequestV3) GetHz() uint32 {
	if m != nil {
		return m.Hz
	}
	return 0
...
type HTBClassConfiguration struct {
	Rate                 uint64   `protobuf:"varint,1,opt,name=rate,proto3" json:"rate,omitempty"`
	Ceil                 uint64   `protobuf:"varint,2,opt,name=ceil,proto3" json:"ceil,omitempty"`
	Buffer               uint32   `protobuf:"varint,3,opt,name=buffer,proto3" json:"buffer,omitempty"`
	Cbuffer              uint32   `protobuf:"varint,4,opt,name=cbuffer,proto3" json:"cbuffer,omitempty"`
...
func (m *HTBClassConfiguration) Reset()         { *m = HTBClassConfiguration{} }
func (m *HTBClassConfiguration) String() string { return proto.CompactTextString(m) }
func (*HTBClassConfiguration) ProtoMessage()    {}
func (*HTBClassConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_95d23e4d548ba1d7, []int{8}
}

func (m *HTBClassConfiguration) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_HTBClassConfiguration.Unmarshal(m, b)
}
func (m *HTBClassConfiguration) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_HTBClassConfiguration.Marshal(b, m, deterministic)
}
func (m *HTBClassConfiguration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HTBClassConfiguration.Merge(m, src)
}
func (m *HTBClassConfiguration) XXX_Size() int {
	return xxx_messageInfo_HTBClassConfiguration.Size(m)
}
func (m *HTBClassConfiguration) XXX_DiscardUnknown() {
	xxx_messageInfo_HTBClassConfiguration.DiscardUnknown(m)
}

var xxx_messageInfo_HTBClassConfiguration proto.InternalMessageInfo

func (m *HTBClassConfiguration) GetRate() uint64 {
	if m != nil {
		return m.Rate
	}
	return 0
...
func (m *HTBClassConfiguration) GetCeil() uint64 {
	if m != nil {
		return m.Ceil
	}
	return 0
...
func (m *HTBClassConfiguration) GetBuffer() uint32 {
	if m != nil {
		return m.Buffer
	}
	return 0
...
func (m *HTBClassConfiguration) GetCbuffer() uint32 {
	if m != nil {
		return m.Cbuffer
	}
	return 0
...
func (m *HTBClassConfiguration) GetQuantum() uint32 {
	if m != nil {
		return m.Quantum
	}
	return 0
...
type FQCodelConfiguration struct {
	// Arguably, these are 0 (default) in our environment
	...
	Quantum              uint32   `protobuf:"varint,5,opt,name=quantum,proto3" json:"quantum,omitempty"`
	CeThreshold          uint32   `protobuf:"varint,6,opt,name=ceThreshold,proto3" json:"ceThreshold,omitempty"`
	DropBatchSize        uint32   `protobuf:"varint,7,opt,name=dropBatchSize,proto3" json:"dropBatchSize,omitempty"`
	MemoryLimit          uint32   `protobuf:"varint,8,opt,name=memoryLimit,proto3" json:"memoryLimit,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *FQCodelConfiguration) Reset()         { *m = FQCodelConfiguration{} }
func (m *FQCodelConfiguration) String() string { return proto.CompactTextString(m) }
func (*FQCodelConfiguration) ProtoMessage()    {}
func (*FQCodelConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_95d23e4d548ba1d7, []int{9}
}

func (m *FQCodelConfiguration) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FQCodelConfiguration.Unmarshal(m, b)
}
func (m *FQCodelConfiguration) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FQCodelConfiguration.Marshal(b, m, deterministic)
}
func (m *FQCodelConfiguration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FQCodelConfiguration.Merge(m, src)
}
func (m *FQCodelConfiguration) XXX_Size() int {
	return xxx_messageInfo_FQCodelConfiguration.Size(m)
}
func (m *FQCodelConfiguration) XXX_DiscardUnknown() {
	xxx_messageInfo_FQCodelConfiguration.DiscardUnknown(m)
}

var xxx_messageInfo_FQCodelConfiguration proto.InternalMessageInfo

func (m *FQCodelConfiguration) GetTarget() uint32 {
	if m != nil {
		return m.Target
	}
	return 0
...
func (m *FQCodelConfiguration) GetLimit() uint32 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *FQCodelConfiguration) GetInterval() uint32 {
	if m != nil {
		return m.Interval
	}
	return 0
...
func (m *FQCodelConfiguration) GetFlows() uint32 {
	if m != nil {
		return m.Flows
	}
	return 0
...
func (m *FQCodelConfiguration) GetQuantum() uint32 {
	if m != nil {
		return m.Quantum
	}
	return 0
...
func (m *FQCodelConfiguration) GetCeThreshold() uint32 {
	if m != nil {
		return m.CeThreshold
	}
	return 0
}

func (m *FQCodelConfiguration) GetDropBatchSize() uint32 {
	if m != nil {
		return m.DropBatchSize
	}
	return 0
}

func (m *FQCodelConfiguration) GetMemoryLimit() uint32 {
	if m != nil {
...
type ProvisionInstanceResponseV3 struct {
	...
	HtbClassConfiguration *HTBClassConfiguration `protobuf:"bytes,2,opt,name=htbClassConfiguration,proto3" json:"htbClassConfiguration,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}               `json:"-"`
	XXX_unrecognized      []byte                 `json:"-"`
	XXX_sizecache         int32                  `json:"-"`
}
...
func (m *ProvisionInstanceResponseV3) GetHtbClassConfiguration() *HTBClassConfiguration {
	if m != nil {
		return m.HtbClassConfiguration
	}
	return nil
}
...
type AssignIPRequestV3 struct {
	...
	Hz                   uint32   `protobuf:"varint,16,opt,name=hz,proto3" json:"hz,omitempty"`
	BitsPerSecond        uint64   `protobuf:"varint,17,opt,name=bitsPerSecond,proto3" json:"bitsPerSecond,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *AssignIPRequestV3) GetHz() uint32 {
	if m != nil {
		return m.Hz
	}
	return 0
...
func (m *AssignIPRequestV3) GetBitsPerSecond() uint64 {
	if m != nil {
...
type AssignIPResponseV3 struct {
	...
	HtbClassConfiguration *HTBClassConfiguration      `protobuf:"bytes,10,opt,name=htbClassConfiguration,proto3" json:"htbClassConfiguration,omitempty"`
	FqCodelConfiguration  *FQCodelConfiguration       `protobuf:"bytes,11,opt,name=fqCodelConfiguration,proto3" json:"fqCodelConfiguration,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                    `json:"-"`
	XXX_unrecognized      []byte                      `json:"-"`
	XXX_sizecache         int32                       `json:"-"`
}
...
func (m *AssignIPResponseV3) GetHtbClassConfiguration() *HTBClassConfiguration {
	if m != nil {
		return m.HtbClassConfiguration
	}
	return nil
...
func (m *AssignIPResponseV3) GetFqCodelConfiguration() *FQCodelConfiguration {
	if m != nil {
		return m.FqCodelConfiguration
	}
	return nil
}
...
func (*AssignIPResponseV3_Route) Descriptor() ([]byte, []int) {
	return fileDescriptor_95d23e4d548ba1d7, []int{17, 0}
}
...
func (*DescribeTrunkNetworkInterfaceResponse_BranchENI) Descriptor() ([]byte, []int) {
	return fileDescriptor_95d23e4d548ba1d7, []int{41, 1}
}
...
func (*DescribeTrunkNetworkInterfaceResponse_TrunkNetworkInterfaceAssociation) Descriptor() ([]byte, []int) {
	return fileDescriptor_95d23e4d548ba1d7, []int{41, 2}
}
...
func init() {
	...
	proto.RegisterType((*HTBClassConfiguration)(nil), "com.netflix.titus.executor.vpc.HTBClassConfiguration")
	proto.RegisterType((*FQCodelConfiguration)(nil), "com.netflix.titus.executor.vpc.FQCodelConfiguration")
...
var fileDescriptor_95d23e4d548ba1d7 = []byte{
	...
	,
}
