...
func (Level) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (MountPerm) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
type isRetryPolicy_Policy interface{ isRetryPolicy_Policy() }
...
type TokenBucketPolicy struct {
	...
	InitialNumberOfTokens uint64 `protobuf:"varint,2,opt,name=initialNumberOfTokens" json:"initialNumberOfTokens,omitempty"`
...
func (*TokenBucketPolicy) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }

type isTokenBucketPolicy_RefillStrategy interface{ isTokenBucketPolicy_RefillStrategy() }

type TokenBucketPolicy_FixedIntervalRefillStrategy_ struct {
	FixedIntervalRefillStrategy *TokenBucketPolicy_FixedIntervalRefillStrategy `protobuf:"bytes,3,opt,name=fixedIntervalRefillStrategy,oneof"`
}
...
type TokenBucketPolicy_FixedIntervalRefillStrategy struct {
	RefillRate uint64 `protobuf:"varint,3,opt,name=refillRate" json:"refillRate,omitempty"`
	IntervalMs uint64 `protobuf:"varint,4,opt,name=intervalMs" json:"intervalMs,omitempty"`
}
...
func (*Reference) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }

type isReference_Reference interface{ isReference_Reference() }

type Reference_Global_ struct {
	Global *Reference_Global `protobuf:"bytes,1,opt,name=global,oneof"`
}
type Reference_Tier struct {
	Tier Tier `protobuf:"varint,2,opt,name=tier,enum=com.netflix.titus.Tier,oneof"`
}
type Reference_CapacityGroup struct {
	CapacityGroup string `protobuf:"bytes,3,opt,name=capacityGroup,oneof"`
}
type Reference_JobId struct {
	JobId string `protobuf:"bytes,4,opt,name=jobId,oneof"`
}
type Reference_TaskId struct {
	TaskId string `protobuf:"bytes,5,opt,name=taskId,oneof"`
}
...
func (*Reference_Global) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5, 0} }
...
func (*ResourceDimension) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
