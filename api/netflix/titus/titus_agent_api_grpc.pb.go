...
// All implementations should embed UnimplementedAgentManagementServiceServer
...
// UnimplementedAgentManagementServiceServer should be embedded to have forward compatible implementations.
